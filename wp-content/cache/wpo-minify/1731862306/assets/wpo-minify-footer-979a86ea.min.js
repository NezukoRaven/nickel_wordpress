...
var elementorNotesConfig = {"route":{"title":"Carrito - Nickel","url":"\/?p=9","note_url_pattern":"https:\/\/nickel.cl\/wp-admin\/admin.php?page=elementor-pro-notes-proxy&note-id={{NOTE_ID}}","post_id":9,"is_elementor_library":false},"direction":"ltr","is_debug":false,"current_user_can":{"create":true,"create_users":true,"edit_users":true},"urls":{"admin_url_create_user":"https:\/\/nickel.cl\/wp-admin\/user-new.php","admin_url_edit_user":"https:\/\/nickel.cl\/wp-admin\/user-edit.php","avatar_defaults":{"24":"https:\/\/nickel.cl\/wp-content\/plugins\/ultimate-member\/assets\/img\/default_avatar.jpg","48":"https:\/\/nickel.cl\/wp-content\/plugins\/ultimate-member\/assets\/img\/default_avatar.jpg","96":"https:\/\/nickel.cl\/wp-content\/plugins\/ultimate-member\/assets\/img\/default_avatar.jpg"},"help_notes_features":"https:\/\/go.elementor.com\/app-notes"}};
...
var elementorNotesConfig = {"route":{"title":"Carrito - Nickel","url":"\/?p=9","note_url_pattern":"https:\/\/nickel.cl\/wp-admin\/admin.php?page=elementor-pro-notes-proxy&note-id={{NOTE_ID}}","post_id":9,"is_elementor_library":false},"direction":"ltr","is_debug":false,"current_user_can":{"create":true,"create_users":true,"edit_users":true},"urls":{"admin_url_create_user":"https:\/\/nickel.cl\/wp-admin\/user-new.php","admin_url_edit_user":"https:\/\/nickel.cl\/wp-admin\/user-edit.php","avatar_defaults":{"24":"https:\/\/nickel.cl\/wp-content\/plugins\/ultimate-member\/assets\/img\/default_avatar.jpg","48":"https:\/\/nickel.cl\/wp-content\/plugins\/ultimate-member\/assets\/img\/default_avatar.jpg","96":"https:\/\/nickel.cl\/wp-content\/plugins\/ultimate-member\/assets\/img\/default_avatar.jpg"},"help_notes_features":"https:\/\/go.elementor.com\/app-notes"}};
jQuery(function($){if(typeof wc_country_select_params==='undefined'||typeof wc_city_select_params==='undefined'){return!1}
...
function cityToInput($citybox){if($citybox.is('input')){$citybox.prop('disabled',!1);return}
...
function disableCity($citybox){$citybox.val('').change();$citybox.prop('disabled',!0)}
